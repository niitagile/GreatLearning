...
//Logic to display items on HTML Page
function displayItems(){

    //Fetch category div refernce from html page
    ...
    //add all categories div in an array
    catList = [biryani,paneer,chicken,vegetable,chinese,southIndian]

    //Fetch all objects related to a category in an array
    ...
    [biryaniData,PaneerData,chickenData,vegetableData,chineseData,southData].forEach((foodCategory,idx) => {
