...
function displayItems(){
    //fetch all category elements from html by using getElementById
    ...
    //Fetch data from foodItem array and store them in categorieswise array
    ...
    fooddata=[biryaniData,paneerData,chickenData,vegetableData,chineseData,southData];
    //create different elements to show items one by one
    fooddata.forEach((foodCategory,idx)=>{
        foodCategory.map(item=>{
            //create a dv to display food item
            var itemCard=document.createElement('div');
            itemCard.setAttribute('id','item-card');
            //Another div inside item-card div
            ...
            //create element to display heart
            var heart=document.createElement('i');
            heart.setAttribute('id',item.id);
            star.setAttribute('class','fa fa-heart-o add-to-cart');
